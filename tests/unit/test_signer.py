...
def test_canonical_format():
    ...
    canonical = signer.canonical(
        ...
        status_code=200,
        latency_ms=42,
        request_body_digest="abcd1234",
        response_body_digest="efgh5678",
    )
    assert canonical == "req-123|2026-05-05T10:00:00Z|user-abc|weather-agent|200|42|abcd1234|efgh5678"


def test_sign_and_verify():
    signer = HmacSigner(key="test-key")
    canonical = signer.canonical("r1", "2026-05-05T10:00:00Z", "u1", "a1", 200, 10, "d1", "d2")
...
def test_different_keys_different_sigs():
    ...
    c = s1.canonical("r", "t", "u", "a", 200, 1, "d1", "d2")
